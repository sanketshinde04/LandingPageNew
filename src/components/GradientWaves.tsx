...
/* ------------------------------------------------------------------ *
   GradientWaves, from React Bits (reactbits.dev), ported to TypeScript.

   A raymarched field of sine-plasma waves under a haze. Kept as shipped
   except for four things: the container styles are inline rather than a
   separate stylesheet; the pointer is read from the window so the
   parallax still works when content sits over the canvas; the pixel
   ratio is capped a little lower; and a reduced-motion preference draws
   a single frame instead of running the loop.
 * ------------------------------------------------------------------ */
...
export default function GradientWaves({
  ...
  useEffect(() => {
    ...
    /* read from the window: the hero copy sits over this canvas, so the
       canvas itself would never see the pointer */
